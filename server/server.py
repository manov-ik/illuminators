...
def generate_insights(spo2, heartrate):
    ...
    req = "this is my spo2 level " + str(spo2) + " and this is my heart rate " + str(heartrate) + " give me some insights like what food to eat, what to make it as normal if this is abnormal? give response in 50 to 70 words and give me as points on a seprate line one after other"
